...
- Adding physics to the ground (generated by lines) was a nightmare!
  - Calling `setOrigin` on a game object broke the relationship between the body position and the visual representation.
  - Drawing a line, was quite difficult to understand because we had three points (origin, start and end) and they didn't quite work as I would have expected. It was inconsistent.
...
- [X] ~~*Generate ground randomly*~~ [2021-02-10]
